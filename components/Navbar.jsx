          ...
          <div className="max-w-[700px] w-full flex items-center justify-end">
            ...
            <div className="hidden md:flex">
              ...
              <a 
                ...
                className="px-6 transition min-w-[160px] hover:scale-105 cursor-pointer bg-primary py-[13px] text-center uppercase text-secondary buttonShape text-[12px] font-semibold"
              >
            ...
            <div className="flex md:hidden max-w-max">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="px-6 transition hover:scale-105 cursor-pointer bg-primary py-2.5 text-center uppercase text-secondary buttonShape text-[12px] font-semibold"
                >
                  {process.env.NEXT_PUBLIC_NAVBAR_WALLET_TEXT}
              </a>
