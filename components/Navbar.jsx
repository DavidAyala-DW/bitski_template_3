          ...
          <div className="max-w-[700px] w-full flex items-center justify-end">
            ...
            <div className="hidden md:flex">
              ...
              <a 
                ...
                className="px-6 transition min-w-[160px] hover:scale-105 cursor-pointer bg-primary py-[11px] text-center uppercase text-secondary buttonShape text-[12px] font-semibold"
              >
